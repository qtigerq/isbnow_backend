...
const booksService = require('../service/booksService');                                        //Obtem a camada de serviços
...
const createRandomBook = () => {                                                                //Função para gerar um livro aleatório
    return booksService.saveBook({isbn: getRandomIsbn(), title: getRandomString(20), authors: getRandomString(20)});
};

//TESTES UNITÁRIOS
test('Should get books', async function(){                                                      //GET
    ...
    expect(response.data).toHaveLength(3);                                                          //Verificar se existem 3 livros
